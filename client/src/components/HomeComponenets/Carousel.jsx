        ...
        <>
            <div className="w-full flex items-center justify-center">
                <div className="flex w-full items-center rounded-[30px] relative h-[20rem] md:h-[25rem] lg:h-[30rem] shadow-lg">
                    <img src="https://wallpapercave.com/wp/wp11834767.jpg" alt="spiderman" className="h-full rounded-3xl w-full object-cover" />
                        ...
                        <div className="w-full flex flex-col md:flex-row items-end justify-between">
                            <div className="flex items-start flex-col w-full md:w-1/2 gap-2">
                                <div className="flex text-xs md:text-sm items-center gap-3">
                                    <span className='bg-gray-800/50 border border-gray-700 text-white py-1 rounded-full backdrop-blur-lg px-3 md:px-5'>Animation</span>
                                ...
                                <h1 className='text-xl md:text-2xl lg:text-4xl py-2 font-semibold w-full text-white'>Spiderman: Across the Spider-Verse</h1>
